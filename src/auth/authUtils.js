...
const { UnauthorizedException, NotFoundExeption } = require('../core/error.response');
...
const authentication = asyncHandler(async (req, res, next) => {
  ...
  */
    ...
    if (!userId) throw new UnauthorizedException('Invalid Request 1');
    ...
    if (req.headers[HEADER.REFRESH_TOKEN]) {
        try {
            ...
            if (userId !== decoded.userId) throw new UnauthorizedException('Invalid UserID');
    ...
    if (!accessToken) throw new UnauthorizedException('Invalid Request 2');
